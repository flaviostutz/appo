...
- **Registration Grant**: The output of a successful registration request, containing the newly created device instance identity and one JWT with `sub`, `publ`, and `subs` claims narrowed to that identity.
